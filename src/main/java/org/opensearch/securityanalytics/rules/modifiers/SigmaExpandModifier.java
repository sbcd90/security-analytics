...
public class SigmaExpandModifier extends SigmaValueModifier {

    public SigmaExpandModifier(SigmaDetectionItem detectionItem, List<Class<? extends SigmaModifier>> appliedModifiers) {
